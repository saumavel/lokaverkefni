...
// Game setup translations
        ...
        TranslationManager.add("theme_bathroom", "Pee, Poop, Toilet Paper", "Piss, Kúkur, Klósettpappír");TranslationManager.add("theme_standard_selected", "You chose Rock, Paper, Scissors", "Þú valdir Skæri, Blað, Steinn");
...
// One player game setup
        ...
        TranslationManager.add("difficulty_easy_selected", "🌱 You are now playing difficulty level : Easy", "🌱 Erfiðleikastig : Auðvelt");
...
// Game round
        ...
        TranslationManager.add("secret_hint", "🧑‍🔮 psst... Hate losing? Press 'u' and see what happens.", "🧑‍🔮 psst... Hatar þú að tapa? Ýttu á 'u' og sjáðu hvað gerist.");
        ...
        TranslationManager.add("computer_chose", "🖥️ Computer chose ", "🖥️ Tölvan valdi ");
        ...
        TranslationManager.add("invalid_name_letters", "🚫 Name must contain at least one letter.", "🚫 Nafnið verður að innihalda að minnsta kosti einn staf.");
        ...
        TranslationManager.add("difficulty_increased_easy", "⬆️ Difficulty increased to Easy.", "⬆️ Erfiðleikastig er hækkað í 'Auðvelt'.");
        TranslationManager.add("difficulty_increased_medium", "⬆️ Difficulty increased to Medium.", "⬆️ Erfiðleikastig er hækkað í 'Miðlungs'.");
        TranslationManager.add("difficulty_increased_hard", "⬆️ Difficulty increased to Hard.", "⬆️ Erfiðleikastig er hækkað í 'Erfitt'.");
...
// Bathroom theme moves
        ...
        TranslationManager.add("invalid_name", "✏️ Name cannot be empty. Please enter at least one character.", "✏️ Nafn má ekki vera tómt. Vinsamlegast sláðu inn að minnsta kosti einn staf.");
    }
}